...
- [OpenNBS/OpenNoteBlockStudio](https://github.com/OpenNBS/OpenNoteBlockStudio) - An open-source Minecraft music maker. (1 day ago)
...
- [kookts/kook.ts](https://github.com/kookts/kook.ts) - KOOK Javascript/Typescript SDK (3 days ago)
- [fi6/kBotify](https://github.com/fi6/kBotify) - 开黑啦TypeScript/JavaScript开发框架，几行代码即可制作机器人。包含全部官方API，添加了多个便利的方法，让开发者用尽可能短的代码完成用户交互功能。 (3 days ago)
- [MeteorDevelopment/meteor-bot](https://github.com/MeteorDevelopment/meteor-bot) - Our discord bot (3 days ago)
